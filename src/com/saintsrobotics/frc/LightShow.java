...
public class LightShow {
    ...
    private static final DigitalOutput LIGHT1 = new DigitalOutput(MODULE_NUMBER,
            PIN1);
    private static final DigitalOutput LIGHT2 = new DigitalOutput(MODULE_NUMBER,
            PIN2);
    private static final DigitalOutput LIGHT3 = new DigitalOutput(MODULE_NUMBER,
            PIN3);
