...
public class Pickup implements RobotComponent {
    ...
    public Pickup(JoystickControl controller) {
        ...
        pickupMotor = new Motor(PICKUP_MOTOR_ID, PICKUP_MOTOR_TYPE,
                PICKUP_MOTOR_INVERTED);
        pickupRetractorMotor = new Motor(PICKUP_RETRACTOR_MOTOR_ID,
                PICKUP_RETRACTOR_MOTOR_TYPE, PICKUP_RETRACTOR_MOTOR_INVERTED);
